...
% TODO neodkazovať na subsection - buď kapitola alebo section
...
% TODO Ešte si to znovu prečítať neskôr a možno upraviť, ale inak sa mi to páči
...
% =====
% TODO treba lepšie povedať čo sa snažím urobiť a dokázať:
% Napr. aim of this paper is to compare the SOTA detectors on embedded devices
% to see how the best models perform on computationally restricted devices
...
\autoref{Convolution}.
\todo{Ten obrázok mi nejak nevychádza}
...
\todo{+ obrázok nejaký že input image, feature maps, predictions?}
...
\todo{Že z neho beriem len detection časť?}
...
\todo{Example fotky detekcií z testing setu?}
...
% mobilenet performs better than nano on CPU (TODO pravda že všeobecne? alebo len na RPI?) but doesn't perform much better on GPU? Or just Jetsons?
