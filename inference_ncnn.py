...
from deploy import common as deploy_common
...
def main(args):
    ...
    deploy_config = deploy_common.get_deploy_config(args.deploy_cfg, model_config, "end2end")
    model_config = model_config[0]

    # Get path to the deployed engine
    # TODO
    bin_filepath = "/home/pi/bp/proj/working_dir_yolov8_m_384_conf8/end2end.bin"
    param_filepath = "/home/pi/bp/proj/working_dir_yolov8_m_384_conf8/end2end.param"
    ...
    #  model = task_processor.build_backend_model([bin_filepath, param_filepath], task_processor.update_data_preprocessor)
    model = task_processor.build_backend_model([bin_filepath, param_filepath]) # In this order!
...
if __name__ == "__main__":
    ...
    # TODO engine path -> param and bin filenames
    parser = argparse.ArgumentParser()
    parser.add_argument("deploy_cfg",           type=str, nargs="?", # TODO remove nargs
    ...
    args.deploy_cfg = "deploy/config_ncnn_static.py" # TODO remove
    args.work_dir = "working_dir_yolov8_m_384_conf8" # TODO remove
